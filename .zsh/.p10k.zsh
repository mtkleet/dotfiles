# Generated by Powerlevel10k configuration wizard on 2020-06-10 at 22:16 CEST.
...
() {
    ...
    typeset -g POWERLEVEL9K_RAM_BACKGROUND=55
    # Custom icon.
    ...
    ####################################[ host: current host ]####################################
    typeset -g POWERLEVEL9K_HOST_TEMPLATE="%16F@`ip addr show |grep "inet " |grep -v 127.0.0. |head -1|cut -d" " -f6|cut -d/ -f1`"
    typeset -g POWERLEVEL9K_HOST_BACKGROUND=255
